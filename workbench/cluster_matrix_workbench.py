...
subprocess.run(
    ['cluster_matrix_workbench', coreplus_Archaea_90_110_allType, result_AT_aspralign,
     os.path.join(clustering_Archaea_90_110_allType, 'aspralign_clustering.csv')])
subprocess.run(
    ['cluster_matrix_workbench', coreplus_Archaea_90_110_allType, result_AT_dualgraph,
     os.path.join(clustering_Archaea_90_110_allType, 'dualgraph_clustering.csv')])
subprocess.run(
    ['cluster_matrix_workbench', coreplus_Archaea_90_110_allType, result_AT_nestedalign,
     os.path.join(clustering_Archaea_90_110_allType, 'nestedalign_clustering.csv')])
subprocess.run(
    ['cluster_matrix_workbench', coreplus_Archaea_90_110_allType, result_AT_rnadistance,
     os.path.join(clustering_Archaea_90_110_allType, 'rnadistance_clustering.csv')])
subprocess.run(
    ['cluster_matrix_workbench', coreplus_Archaea_90_110_allType, result_AT_rnaforester,
     os.path.join(clustering_Archaea_90_110_allType, 'rnaforester_clustering.csv')])
subprocess.run(
    ['cluster_matrix_workbench', coreplus_Archaea_90_110_allType, result_AT_treegraph,
     os.path.join(clustering_Archaea_90_110_allType, 'treegraph_clustering.csv')])
# core
subprocess.run(
